...
class Tasks:
    ...
    def add_tasks(self, _id=None, taskname: str = "", description: str = "", notes: str = "", status: str = "",
        ...
        self.definition = {"_id": _id, "taskname": taskname, "description": description, "notes": notes,
                           ...
                           "ownerid": ownerid, "milestoneid": milestoneid, "projectid": projectid}
    ...
    def update_tasks(self, _id=None, taskname: str = None, description: str = None, notes: str = None,
                     ...
                     completedate: str = None, contactid: ObjectId = None, ownerid: ObjectId = None,
                     milestoneid: ObjectId = None, projectid: ObjectId = None):
        if _id is not None:
            if type(_id) is str:
        ...
        if projectid is not None: self.definition["projectid"] = milestoneid
...
class TasksCollection:
    ...
    def get_by_contract(self, contactid, status: str = "All", late_only: bool = False):
        ...
        if status != "All":
            condition_str["status"] = status
        condition_str["contactid"] = ObjectId(contactid)
        return self.myCol.find(condition=condition_str)
